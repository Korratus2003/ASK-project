...
;        esp -> [ret]  ; ret - adres powrotu do asmloader
         ...
         push format_name
;        esp -> [format_name][ret]
         call printf  ; printf(format_name)
         add esp, 4      ; esp = esp + 4
...
;        esp -> [format_n][addr_n][ret]
         call scanf  ; scanf(format_n, addr_n)
...
;        esp -> [format3][esi][fl][fh][ret]
         ...
         call printf  ; printf(format3, esi, fl:fh);
...
;        esp -> [format4][esi][fl][fh][ret]
         ...
         call printf   ; printf(format4, esi, fl:fh);
         add esp, 4*4  ; esp = esp + 16
...
nasm sequence.asm -o sequence.o -f elf32

gcc sequence.o -o sequence -m32 -no-pie
%endif
