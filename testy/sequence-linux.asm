...
;        st = []  ; fpu stack
         ...
         ; Resetuj wartości początkowe
         fld1                       ; st = [1.0]
         fld1                       ; st = [1.0, 1.0] 
         fld1                       ; st = [1.0, 1.0, 1.0]
         fadd st0, st1              ; st = [2.0, 1.0, 1.0]
         fadd st0, st1              ; st = [3.0, 1.0, 1.0] = a
         fstp qword [addr_a]        ; addr_a = 3.0, st = [1.0, 1.0]
         fadd st0, st1              ; st = [2.0, 1.0]
         fadd st0, st1              ; st = [3.0, 1.0]
         fadd st0, st1              ; st = [4.0, 1.0] = b
         fstp qword [addr_b]        ; addr_b = 4.0, st = [1.0]
         fstp st0                   ; st = []
...
;        st = []  ; fpu stack
         ...
         fld1                       ; st = [1.0, 1.0, 1.0]
         fadd st0, st1              ; st = [2.0, 1.0, 1.0]
         fadd st0, st1              ; st = [3.0, 1.0, 1.0] = a1
         fstp qword [addr_a1]       ; addr_a1 = 3.0, st = [1.0, 1.0]
         fadd st0, st1              ; st = [2.0, 1.0]
         fadd st0, st1              ; st = [3.0, 1.0]
         fadd st0, st1              ; st = [4.0, 1.0] = b1
         fstp qword [addr_b1]       ; addr_b1 = 4.0, st = [1.0]
         fadd st0, st0              ; st = [2.0]
         fadd st0, st0              ; st = [4.0]
         fadd st0, st0              ; st = [8.0] = c1
         fstp qword [addr_c1]       ; addr_c1 = 8.0, st = []
